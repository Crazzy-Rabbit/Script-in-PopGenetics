...
open (BBB,"QC.ld.dorper-dorset-bcftools-502502-geno02-maf03_correction_nchr.fam") || die "can't open BBB"; 
open (CCC,">dorper-dorset-bcftools-502502-geno02-maf03_correction_nchr.meg");
my @aa=<AAA>;
my @bb=<BBB>;
