...
Winsizelink="/home/sll/genome-cattle/CNVCaller-Duplink/ARS-UCD1.2_1000.link"             #dup file that you have created use blasr, change as you want

winsize=1000
echo "CNVReferenceDB.pl:    $CNVReferenceDBpl";
echo "genomic.fna:    $genomicfa";
