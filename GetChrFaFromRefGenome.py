...
@click.option('-C', '--getchr', type=str, help='要提取的chr, such ">NC_040252.1", 必须有>', required=True)
@click.option('-c', '--getchrs', type=str, help='要提取的chr的下一个chr, 如 ">NC_040253.1", 必须有>', required=True)
