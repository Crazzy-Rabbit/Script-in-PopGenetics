...
sawriter="/home/sll/software/blasr/alignment/bin/SAWriter"                                    #change as you want
...
python $0.1.Kmer_Generate.py $genomic.fna $winsize kmer.fa
...
$sawriter genomic.fna.sa $genomic.fna
# 2) blasr 
...
python $0.2.Kmer_Link.py kmer.aln $winsize Bos_ARS1.2_${winsize}.link
